const Search = () => {
    return (
        <svg className="search" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
            <g clip-path="url(#clip0_597_215)">
                <circle className="iconca" cx="6.5" cy="6.5" r="5.75"  stroke-width="1.5" />
                <path className="iconca" d="M11 11L15 15"  stroke-width="1.5" stroke-linecap="round" />
            </g>
            <defs>
...
const Notification = () => {
    return (
        <svg className="notification" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
...
const Line = () => {
    return (
        <svg className="line" xmlns="http://www.w3.org/2000/svg" width="2" height="32" viewBox="0 0 2 32" fill="none">
...
export { Search, Notification, Line}